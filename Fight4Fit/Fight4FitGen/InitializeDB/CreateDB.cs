    ...
    public class CreateDB
    {
        ...
        public static void InitializeData()
        {
            ...
            try
            {
                ...
                reporteCP.NuevoReporte(reporteEN.Texto, reporteEN.Motivo, reporteEN.Usuario.Email, 1, reporteEN.Tipo);
                ...
                reporteCP.NuevoReporte(reporte1EN.Texto, reporte1EN.Motivo, reporte1EN.Usuario.Email, 1, reporte1EN.Tipo);
                ...
                comentarioCP.PublicarComentario(comentarioEN.Titulo, comentarioEN.Texto, 0, 1);

                ComentarioEN comentario2EN = new ComentarioEN();
                comentario2EN.Titulo = "Golf";
                comentario2EN.Texto = "El golf es muy divertido";
                comentarioCP.PublicarComentario(comentario2EN.Titulo, comentario2EN.Texto, 0, 1);

                ComentarioEN comentario3EN = new ComentarioEN();
                comentario3EN.Titulo = "Tenis";
                comentario3EN.Texto = "El tenis es muy divertido";
                comentarioCP.PublicarComentario(comentario3EN.Titulo, comentario3EN.Texto, 0, 1);

                comentarioCEN.Darlike(1);
                comentarioCEN.Darlike(1);
                comentarioCEN.Darlike(1);
                comentarioCEN.Darlike(1);
                comentarioCEN.Darlike(3);
                comentarioCEN.Darlike(3); 
                comentarioCEN.Darlike(2);
